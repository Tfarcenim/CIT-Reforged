package schm.shsupercm.citresewn.pack.format;
...
public abstract class PropertyGroup {
     ...
     * @throws net.minecraft.ResourceLocationException if encountered a malformed {@link ResourceLocation} while reading
     */
     ...
     * @param propertiesResourceLocation the value's property group location identifier
     ...
     */
    protected void put(int position, String packName, ResourceLocation propertiesResourceLocation, String key, String keyMetadata, PropertySeparator separator, String value) {
        Objects.requireNonNull(key);
        Objects.requireNonNull(value);

        this.properties.computeIfAbsent(PropertyKey.of(key), id -> new LinkedHashSet<>()).add(new PropertyValue(keyMetadata, value, separator, position, propertiesResourceLocation, packName));
    }
