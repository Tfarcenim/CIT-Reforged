        ...
        for (CIT<?> cit : cits) {
            ...
            if (cit.fallback == null) {
                if (fallbackCITResewnRoot && cit.propertiesIdentifier.getPath().startsWith("citresewn/")) {
                    ...
                    remove.add(ResourceLocation.fromNamespaceAndPath(cit.propertiesIdentifier.getNamespace(), "optifine/" + subPath));
                    remove.add(ResourceLocation.fromNamespaceAndPath(cit.propertiesIdentifier.getNamespace(), "mcpatcher/" + subPath));
                }
            } else {
