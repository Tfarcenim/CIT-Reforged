...
public class CITEnchantment extends CIT {
    ...
    public final Map<Dummy.GlintRenderLayer, RenderType> renderLayers = new EnumMap<>(Dummy.GlintRenderLayer.class);
    ...
    //dummy class is used to cut down on accessor mixins
    public abstract static class Dummy extends RenderStateShard {
